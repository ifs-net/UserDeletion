...
define('_USERDELETIONUPDATED',		'Data stored');
define('_USERDELETIONUSERNOTFOUND',	'User not found');
define('_USERDELETIONDELBUTTON',	'delete user');
define('_USERDELETIONDELETEUSER',	'Delete all data for user');
define('_USERDELETIONREALLYDELETE',	'Do you really want to delete the user');
define('_USERDELETIONCANCEL',		'Cancel and return to last page');
?>